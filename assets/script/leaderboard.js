...
function getData(){
    ...
    var URL = "https://uaf-programmers-default-rtdb.firebaseio.com/PythonSessions.json"
...
function setData(){
    ...
    if(all_students_arr.length <= 0){

        document.getElementById("bottom").innerText = "No Students Here..."         
        ...
        for(let student of all_students_arr){
    
            // let student = all_students_arr[i]
